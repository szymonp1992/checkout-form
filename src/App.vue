  ...
  <div class="container">
    <form class="row g-3 needs-validation checkout-form" novalidate>
      ...
      <div class="input-group ps-0">
        ...
        <div class="form-floating">
          <input type="text" id="surname" class="form-control" placeholder="Surname" v-model="surname" required />
          <div class="invalid-feedback">
      ...
      <div class="form-floating col-12 col-md-6 ps-0">
        <input type="text" id="street" class="form-control" placeholder="Street address" v-model="street" required />
        <div class="invalid-feedback">
      ...
      <div class="form-floating col-6 col-md-3 ps-0">
        <input type="text" id="house-number" class="form-control" placeholder="House no." v-model="houseNo" required />
        <div class="invalid-feedback">
      ...
      <div class="form-floating col-4 ps-0">
        <input type="text" id="zip-code" class="form-control" placeholder="Zip code" v-model="zipCode" required />
        <div class="invalid-feedback">
    ...
    onMounted(() => {
      ...
      checkoutForm.addEventListener('submit', event => {
        if (!checkoutForm.checkValidity()) {
          ...
          console.log(entries[0].email.value)
          isFormValid = true;
        }
